import { type IntentResult, intentClassifier } from '@/services/intent-classifier';
...
export async function executeIntentClassificationTask(
	...
	try {
		...
		loggers.ai.error({ err: error, phase }, '❌ Falha na tarefa de intent classification, aplicando fallback contratual');
