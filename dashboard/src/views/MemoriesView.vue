...
const { data: memories, isLoading } = useQuery({
	...
	queryFn: () => dashboardService.getMemories(searchQuery.value),
});
...
const iconMap: Record<string, any> = {
	...
	note: Type,
	video: Layers,
	audio: ImageIcon, // Usando ImageIcon como fallback razoável
};
...
const createMutation = useMutation({
	mutationFn: (payload: any) => dashboardService.createMemory(payload),
	onSuccess: () => {
...
const updateMutation = useMutation({
	mutationFn: ({ id, payload }: { id: string | number; payload: any }) => dashboardService.updateMemory(id, payload),
	onSuccess: () => {
		queryClient.invalidateQueries({ queryKey: ['memories'] });
...
const deleteMutation = useMutation({
	mutationFn: (id: string | number) => dashboardService.deleteMemory(id),
	onSuccess: () => {
		queryClient.invalidateQueries({ queryKey: ['memories'] });
