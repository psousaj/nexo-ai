			...
			<div class="flex items-center gap-3">
				<div class="relative">
					...
					<input
						...
						class="pl-10 pr-4 py-2 bg-white dark:bg-surface-900 border border-surface-200 dark:border-surface-800 rounded-xl text-sm focus:ring-2 focus:ring-primary-500 transition-all w-64 outline-none"
					/>
				</div>
			</div>
		</div>
