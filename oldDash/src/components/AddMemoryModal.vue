...
<template>
	<Transition name="fade">
		<div v-if="isOpen" class="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
			...
			<!-- Modal Content -->
			<div
				class="relative w-full max-w-lg bg-white dark:bg-surface-900 rounded-3xl shadow-2xl overflow-hidden animate-slide-up border border-surface-200 dark:border-surface-800"
			>
