...
<template>
	<div class="premium-card group">
		<div v-if="loading" class="animate-pulse flex space-x-4">
			<div class="rounded-full bg-surface-200 dark:bg-surface-800 h-12 w-12"></div>
		...
		<div v-else class="flex flex-col gap-4">
			...
			<div>
				<h3 class="text-sm font-medium text-surface-500 dark:text-surface-400 mb-1">{{ title }}</h3>
