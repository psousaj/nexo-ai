...
export function addRuntimeBlock(round: RuntimeRound, block: RuntimeRoundBlock): RuntimeRound {
	round.blocks.push(block);
	return round;
}

export function mapOpenAIFinishReasonToRuntimeStopReason(finishReason: string | null | undefined): RuntimeStopReason {
