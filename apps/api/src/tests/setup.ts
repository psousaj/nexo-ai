...
process.env.DATABASE_URL =
  process.env.DATABASE_URL || "postgresql://localhost:5432/nexo";
...
process.env.CLOUDFLARE_GATEWAY_ID =
  process.env.CLOUDFLARE_GATEWAY_ID || "nexo-ai-gateway";
process.env.CF_GATEWAY_MODEL = process.env.CF_GATEWAY_MODEL || "dynamic/nexo";
process.env.CF_INTENT_MODEL = process.env.CF_INTENT_MODEL || "dynamic/nexo";
process.env.CF_EMBED_MODEL = process.env.CF_EMBED_MODEL || "dynamic/embeddings";
