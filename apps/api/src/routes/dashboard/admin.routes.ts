      ...
      return c.json(
        {
          ...
          error:
            error instanceof Error
              ? error.message
              : "Erro ao conectar instância Evolution",
        },
        500,
      );
    }
      ...
      return c.json(
        {
          success: false,
          error:
            error instanceof Error ? error.message : "Erro ao atualizar tool",
        },
        400,
      );
    }
      ...
      return c.json(
        {
          success: false,
          error:
            error instanceof Error ? error.message : "Erro ao habilitar tools",
        },
        500,
      );
    }
      ...
      return c.json(
        {
          success: false,
          error:
            error instanceof Error ? error.message : "Erro ao atualizar flag",
        },
        400,
      );
    }
      ...
      return c.json(
        {
          success: false,
          error:
            "CLOUDFLARE_ACCOUNT_ID ou CLOUDFLARE_GATEWAY_ID não configurados",
        },
        400,
      );
    }
